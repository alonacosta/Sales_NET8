        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Category category)
        {
            ...
            .AnyAsync(c => c.Name == category.Name);
                ...
                catch (DbUpdateException ex)
                {
                    ...
                    {
                        ModelState.AddModelError("", "Ocorreu um erro ao guardar a categoria. Já existe uma categoria com este nome.");
                    }
                    else
                    {
                        ModelState.AddModelError("", "Ocorreu um erro ao guardar a categoria.");
                    }
                    return View(category);
                }
